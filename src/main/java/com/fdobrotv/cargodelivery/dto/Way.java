...
public class Way {
   ...
   */
  public Way(UUID id, String name, String description, Settlement departureSettlement, Settlement destinationSettlement) {
    this.id = id;
    this.name = name;
  ...
  */
  @Valid 
  @Schema(name = "roads", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("roads")
