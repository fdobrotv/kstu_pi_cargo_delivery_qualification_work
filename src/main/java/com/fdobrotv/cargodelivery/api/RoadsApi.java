...
@Validated
@Tag(name = "roads", description = "the roads API")
public interface RoadsApi {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Ok", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Road.class))
            }),
    ...
    default ResponseEntity<Road> createRoad(
        @Parameter(name = "RoadIn", description = "") @Valid @RequestBody(required = false) RoadIn roadIn
    ) {
    ...
    /**
     * DELETE /roads/{id} : Delete specific food option by id
     *
    ...
    default ResponseEntity<Void> deleteRoadById(
    ...
    /**
     * GET /roads/{id} : Info for a specific food option
     *
    ...
    default ResponseEntity<Road> getRoadById(
     ...
     * @return A paged array of roads (status code 200)
     *         or unexpected error (status code 200)
     */
    @Operation(
        ...
        tags = { "roads" },
        responses = {
            @ApiResponse(responseCode = "200", description = "A paged array of roads", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = Road.class)))
            }),
            @ApiResponse(responseCode = "default", description = "unexpected error", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = Error.class))
            })
    ...
    default ResponseEntity<List<Road>> listRoads(
