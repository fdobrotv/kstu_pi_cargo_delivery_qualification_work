...
export interface GetCarMarkByIdRequest {
    id: string;
}
...
export class CarMarksApi extends runtime.BaseAPI {
     ...
     */
    async getCarMarkByIdRaw(requestParameters: GetCarMarkByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CarMark>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getCarMarkById.');
        }
     ...
     * Info for a specific car mark
     */
    async getCarMarkById(requestParameters: GetCarMarkByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CarMark> {
        const response = await this.getCarMarkByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
