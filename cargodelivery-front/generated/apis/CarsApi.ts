...
export class CarsApi extends runtime.BaseAPI {
     ...
     */
    async getCarByIdRaw(requestParameters: GetCarByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Car>> {
        if (requestParameters.id === null || requestParameters.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter requestParameters.id was null or undefined when calling getCarById.');
        }
     ...
     * Info for a specific car
     */
    async getCarById(requestParameters: GetCarByIdRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Car> {
        const response = await this.getCarByIdRaw(requestParameters, initOverrides);
        return await response.value();
    }
